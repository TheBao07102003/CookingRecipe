...
import "./JapanRecipes.css"; // Import styles
  ...
  return (
    <div className="japan-recipes-container">
      <h1
        style={{
          backgroundImage:
            "url(https://i0.wp.com/www.touristjapan.com/wp-content/uploads/2023/04/fujiyoshida-view-scaled-e1680427764989.jpg?resize=2000%2C800&ssl=1)",
            filter: 'blur(4px)',
          padding: "150px",
        }}
      > 
