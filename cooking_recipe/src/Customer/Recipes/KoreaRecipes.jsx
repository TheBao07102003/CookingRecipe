...
import "./KoreaRecipes.css"; // Import styles
...
const KoreaRecipes = () => {
  ...
  return (
    <div className="korea-recipes-container">
      <h1
        style={{
          backgroundImage:
            "url(https://www.wcccsa.com/wp-content/uploads/2023/05/Korea-Businesses.jpg)",
            filter: 'blur(4px)',
          padding: "150px",
        }}
      > 
