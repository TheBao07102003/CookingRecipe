...
const News = () => {
  return (
    <div style={{ backgroundColor: "#FAF0DE" }}>
      <div
        className="header"
        style={{
      ...
      >
        <h1 style={{ margin: 0, fontSize: "36px", color: "#8b4513" }}>
          CookCook News
        </h1>
      </div>
      <div
      ...
      >
        ...
        >
          <h2
            style={{ fontSize: "24px", color: "#8b4513", margin: "0 0 20px 0" }}
          >
            Food Combinations to Avoid: Ingredients That Don’t Pair Well and
            Their Effects
          </h2>
          <div className="food-combination" style={{ marginBottom: "20px" }}>
            <h3 style={{ fontSize: "20px", color: "#8b4513", margin: 0 }}>
